...
const projects = [
  ["Cool New Tech Blog", "Cool New Tech Blog is a full stack web application that I developed independently. Users have the ability to make posts and comment on other users posts. Uses Node.js, Express.js, MySQL, and Bootstrap, and is deployed through Heroku.", "https://tech-blog-0423.herokuapp.com/", "https://github.com/jzelasky/techBlog", techBlogImg],
  ...
  ["Breaking Dad", "Breaking Dad is a front end web application developed by myself and a group of classmates. Users are able to click buttons to receive a dad joke or a breaking dad quote. I was responsible for part of the front end Javascript. It uses Node.js and Bulma and is deployed through Github Pages.", "https://cellopudding.github.io/BreakingDad", "https://github.com/cellopudding/BreakingDad", breakingImg],
]
